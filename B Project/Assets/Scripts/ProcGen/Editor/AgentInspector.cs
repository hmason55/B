...
namespace ProcGen
{
    ...
    public class AgentInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            tileSize.floatValue = EditorGUILayout.FloatField(new GUIContent("Tile Size", "The size of the tile, the size is the length from the center to one of the verticies."), tileSize.floatValue);
            ...
            if (showMore)
            {
                ...
                EditorGUILayout.PropertyField(onRandom, new GUIContent("onRandom"));
            }
            ...
            EditorGUILayout.LabelField(new GUIContent("Map Width: "), new GUIContent(procGen.mapWidth.ToString()));
            EditorGUILayout.LabelField(new GUIContent("Map Height: "), new GUIContent(procGen.mapHeight.ToString()));
            EditorGUILayout.Space();
