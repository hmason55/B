...
namespace ProcGen
{
    ...
    public class ProcAgent : MonoBehaviour
    {
        ...
        {
            return Mathf.Sqrt(3) * tileSize + tilePaddingX;
        }

        public float HexHeight()
        {
            return 2 * tileSize + tilePaddingY;
        }
        ...
        public List<Vector2Int> Neighbours(int x, int y)
        {
            int[] b = Basis(y);
        ...
        public List<Vector2Int> Neighbours(Vector2Int pos)
        {
        ...
        public List<Vector2Int> Neighbours(int x, int y, List<Vector2Int> neigh, bool[] visited, ProcData[,] map)
        {
            int[] b = Basis(y);
            for (int i = 0; i < b.Length; i += 2)
            {
        ...
        public Vector2Int[] Line(int x1, int y1, int x2, int y2)
        {
        ...
        public Vector2Int[] Line(Vector2Int a1, Vector2Int b1)
        {
        ...
        public List<Vector2Int> BFS(int x, int y, bool[] visited, ProcData[,] map)
        {
        ...
        public Vector3 CubeLerp(Vector3Int a, Vector3Int b, float t)
        {
            return new Vector3(
        ...
        /// <summary>
        /// Converts cube coordinates to OddR representation
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="z"></param>
        ...
        public Vector2Int CubeToOddR(Vector3Int a)
        {
            return CubeToOddR(a.x, a.y, a.z);
        }

        /// <summary>
        /// Converse OddR coordines to Cube representation
        /// </summary>
        /// <param name="a0"></param>
        /// <param name="a1"></param>
        /// <returns></returns>
        public Vector3Int OddRToCube(int a0, int a1)
        {
            int x = a0 - (a1 - (a1 & 1)) / 2;
            int z = a1;
            int y = -x - z;
        ...
        public Vector3Int OddRToCube(Vector2Int a)
        {
            return OddRToCube(a.x, a.y);
        }

        public int Distance(int a0, int a1, int b0, int b1)
        {
